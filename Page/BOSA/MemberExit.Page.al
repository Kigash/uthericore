    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Net Payment"; Rec."Net Payment")
                {
        ...
        area(processing)
        {
            ...
            action(PostExit)
            {
                ...
                begin
                    ...
                    if Confirm('Are You Sure You Want to Post This Exit Application', true) then begin
                        Bosa.PostMemberExit(Rec);
                        CurrPage.Close();
                    end;
                end;
            }
