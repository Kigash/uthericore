page 50260 "Loan Rescheduling"
{
    ...
    begin
        IF (Rec."Rescheduling Type" = Rec."Rescheduling Type"::"Repayment Period") THEN
            IsRepaymentPeriodVisible := TRUE
        ELSE
            IsRepaymentPeriodVisible := FALSE;
        IF (Rec."Rescheduling Type" = Rec."Rescheduling Type"::"Repayment Frequency") THEN
            IsRepaymentFrequencyVisible := TRUE
        ELSE
            IsRepaymentFrequencyVisible := FALSE;
        IF (Rec."Rescheduling Type" = Rec."Rescheduling Type"::"Interest Rate") THEN
