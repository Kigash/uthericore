    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Total Collected Amount"; Rec."Total Collected Amount")
                {
                    ApplicationArea = All;
                }
    ...
    actions
    {
        area(processing)
        {
            action(SendApprovalRequest)
            {
                ...
                begin
                    IF NOT Rec.CheckAllocationEntriesExist THEN
                        ERROR(Error000);

                    Rec.CalcFields("Total Remaining Amount");
                    Rec.TestField("Total Remaining Amount", 0);
            ...
            action(Print)
            {
                ...
                begin
                    ...
                    REPORT.RUN(50201, TRUE, FALSE, Rec);
                end;
            }
            action(Approve)
            {
