page 50143 "Mobile Banking Appl. Card"
{
    // version TL2.0
    ...
    actions
    {
        area(processing)
        {
            action(SendApprovalRequest)
            {
                ...
                begin
                    IF ApprovalsMgmt.CheckMobileBankingApplicationApprovalPossible(Rec) THEN begin
                        ApprovalsMgmt.OnSendMobileBankingApplicationForApproval(Rec);
                        CurrPage.Close();
                    end;
                end;
            }
            action(CancelApprovalRequest)
            {
                ...
                begin
                    ApprovalsMgmt.OnCancelMobileBankingApplicationApprovalRequest(Rec);
                end;
            }
            action(Approve)
            {
