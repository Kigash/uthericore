page 50060 "Teller Transaction Card"
{
    PageType = Card;
    ApplicationArea = All;
    UsageCategory = Tasks;
        ...
        area(Reporting)
        {
            ...
            /*action(Reverse3)
            {
                ...
                var
                    ReversalEntry: Record "Reversal Entry";
                    BOSAManagement: Codeunit "BOSA Management";
                    ReversalSuccessful: Boolean;
                    ErrorMsg: Label 'No G/L entries found for transaction %1 or they are already reversed.';
                begin
                    if Confirm(ReverseConfirmMsg, true) then begin
                        ...
                        if ReversalSuccessful then begin
                            Rec.Reversed := true;
                            Rec.Posted := false;
                            Rec.Status := Rec.Status::New;
                            Rec.Modify(true);
                            ...
                            Error('Reversal failed for transaction %1.', Rec."No.");
                    end;
                end;
            }*/
        }
