page 50050 PurchaseInvNewCard
{
    Caption = 'Purchase Invoice New Card';
    PageType = Document;
        ...
        area(processing)
        {
            ...
            group("Request Approval")
            {
                ...
                action(Approvals)
                {
                    ...
                    begin
                        //WorkflowsEntriesBuffer.RunWorkflowEntriesPage(Rec.RECORDID, DATABASE::"Purchase Header", "Document Type".AsInteger(), Rec."No.");
                    end;
                }
    ...
    begin
        ...
        DocumentIsPosted := (not Rec.Get(Rec."Document Type", Rec."No.")) or IsScheduledPosting;
