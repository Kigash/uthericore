page 50732 "Store Return Application Card"
{
    // version TL2.0
        ...
        area(creation)
        {
            ...
            group(Issuance)
            {
                ...
                action("Create Item Journal Line")
                {
                    ...
                    PromotedCategory = Category4;
                    PromotedIsBig = true;
                    ToolTip = 'Create Item Journal Line & Post';
                    Visible = SeeReturn;
    ...
    begin
        ...
        IF (Rec.Status = Rec.Status::Released) THEN
            SeeReturn := TRUE
        ELSE
            IF (Rec.Status = Rec.Status::Released) AND (Rec."Issuance Status" = Rec."Issuance Status"::Returned) THEN BEGIN
                SeeReturn := FALSE;
            END;
    end;
}
