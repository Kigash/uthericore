page 50760 "Supplier Evaluation Card"
{
    ...
    layout
    {
        area(content)
        {
            ...
            group(Scores)
            {
                field("Mandatory Score"; Rec."Mandatory Score")
                {
                    Editable = false;
                }
                field("Mandatory Requirements Summary"; Rec."Mandatory Requirements Summary")
                {
                    Editable = false;
                }
                ...
                field("Technical Requirements Summary"; Rec."Technical Requirements Summary")
                {
                    Editable = false;
                }
                ...
                field("Financial Requirements Summary"; Rec."Financial Requirements Summary")
                {
                    Editable = false;
                }
                ...
                field("Overall Requirements Summary"; Rec."Overall Requirements Summary")
                {
                    Editable = false;
                }
            }
    ...
    actions
    {
        area(processing)
        {
            ...
            action("Forward for Technical Evaluation")
            {
                ...
                trigger OnAction();
                begin
                    Rec.TestField("Mandatory Score");
                    Rec.TestField("Mandatory Requirements Summary", Rec."Mandatory Requirements Summary"::Pass);
            ...
            action("Forward for Financial Evaluation")
            {
                ...
                begin
                    ...
                    Rec.TestField("Technical Requirements Summary", Rec."Technical Requirements Summary"::Pass);
            ...
            action("Generate Average Total Score")
            {
                ...
                begin
                    IF Rec.Amount = 0 THEN
                        Rec."Amount" := Rec."Quoted Amount";
                    Rec.MODIFY;
                    //TESTFIELD(Rec."Amount"));
            ...
            action("Forward for Award")
            {
                ...
                trigger OnAction();
                begin
                    Rec.TestField("Financial Requirements Summary", Rec."Financial Requirements Summary"::Pass);
                    Rec.TestField("Total Score");
                    Rec.TestField("Overall Requirements Summary");
            ...
            action("All Requirements")
            {
                ...
                begin
                    ...
                    SupplierEvaluation.SETRANGE("Vendor No.", Rec."Vendor No.");
                    SupplierEvaluation.SETRANGE("Process No.", Rec."Process No.");
            ...
            action("Send Regret Letter")
            {
                ...
                trigger OnAction();
                begin
                    ProcurementManagement.SendLetter(Rec, Rec."Evaluation Stage");
                    CurrPage.CLOSE;
                end;
            }
    ...
    begin
        ...
        SeeAwarding := FALSE;
        IF Rec."Evaluation Stage" = Rec."Evaluation Stage"::Mandatory THEN BEGIN
            SeeMandatory := TRUE;
            SeeMandatory2 := TRUE;
        END;
        IF Rec."Evaluation Stage" = Rec."Evaluation Stage"::Technical THEN BEGIN
            SeeTechnical := TRUE;
            SeeTechnical2 := TRUE;
        END;
        IF Rec."Evaluation Stage" = Rec."Evaluation Stage"::Financial THEN BEGIN
            SeeFinancial := TRUE;
            SeeFinancial2 := TRUE;
        END;
        IF Rec."Evaluation Stage" = Rec."Evaluation Stage"::Awarding THEN BEGIN
        ...
        ProcurementProcessEvaluation.SETRANGE("Process No.", Rec."Process No.");
        ...
        IF ProcurementProcessEvaluation.FINDFIRST THEN BEGIN
            IF ProcurementProcessEvaluation."Vendor Name" <> Rec."Vendor Name" THEN BEGIN
