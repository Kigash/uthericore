page 50711 "Submitted Plans - CEO's Desk"
{
    ...
    layout
    {
        area(content)
        {
            repeater("")
            {
                ...
                field("Forwarded To CEO?"; Rec."Forwarded To CEO?")
                {
                    ApplicationArea = All;
                }
            }
        ...
        area(processing)
        {
            action("View Submitted Plan")
            {
                ...
                begin
                    ...
                    ProcurementPlanHeader1.SETRANGE("Current Budget", Rec.Name);
            ...
            action("View Plans Not Submitted")
            {
                ...
                begin
                    ...
                    PlanSubmissionEntries2.SETRANGE("Current Budget", Rec.Name);
    ...
    begin
        GLSetup.GET;
        Rec.FILTERGROUP(2);
        Rec.SETRANGE(Name, GLSetup."Current Bugdet");
        Rec.FILTERGROUP(0);
