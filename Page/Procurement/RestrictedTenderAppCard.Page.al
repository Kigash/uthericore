page 50796 "Restricted Tender App Card"
{
    // version TL2.0
        ...
        area(processing)
        {
            action("Select Suppliers")
            {
                ...
                begin
                    ...
                    Rec.TestField("Advertisement Date");
                    Rec.TestField("Tender Fee");
            ...
            action("Generate Purchase Order")
            {
                ...
                trigger OnAction();
                begin
                    Rec.TestField("Contract Generated", FALSE);
    ...
    begin
        Rec."Procurement Option" := Rec."Procurement Option"::"Restricted Tender";
