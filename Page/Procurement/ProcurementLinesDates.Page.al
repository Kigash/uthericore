    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Document Opening Date"; Rec."Document Opening Date")
                {
                    ApplicationArea = All;
                }
                ...
                field("Contract Completion Date"; Rec."Contract Completion Date")
                {
                    ApplicationArea = All;
                }
            }
    ...
    actions
    {
        area(processing)
        {
            action("Update Plan Dates")
            {
                ...
                trigger OnAction();
                begin
                    CurrPage.SETSELECTIONFILTER(Rec); Rec.TestField("Advertisement Date"); Rec.TestField("Procurement Method");
