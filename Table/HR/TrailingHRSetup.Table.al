table 50288 "Trailing HR Setup"
{
    Caption = 'Trailing HR Setup';
    ...
    fields
    {
        ...
        field(3; "Show Employee"; Option)
        {
            Caption = 'Show Employee';
            OptionCaption = 'All,Confirmed,Probation,Terminated';
            OptionMembers = "All","Confirmed","Probation","Terminated";
        }
        field(4; "Use Work Date as Base"; Boolean)
        {
            Caption = 'Use Work Date as Base';
        }
        field(5; "Chart Type"; Option)
        {
            Caption = 'Chart Type';
        ...
        field(6; "Value to Calculate"; Option)
        {
            Caption = 'Value to Calculate';
            OptionCaption = 'Amount Excl. VAT,No. of Employees';
            OptionMembers = "Amount Excl. VAT","No. of Employees";
        }
    ...
    begin
        if "Use Work Date as Base" then
            ...
            StartDate := Today;
        if "Show Employee" = "Show Employee"::All then begin
    ...
    procedure SetShowEmployees(ShowEmployees: Integer)
    begin
        "Show Employee" := ShowEmployees;
        Modify;
    end;
