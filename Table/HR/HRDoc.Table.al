table 50214 "Human Resource Document"
{
    // version TL2.0
    ...
    local procedure OnBeforeInsertAttachment(var DocumentAttachment: Record "Human Resource Document"; var RecRef: RecordRef)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeSaveAttachment(var DocumentAttachment: Record "Human Resource Document"; var RecRef: RecordRef; FileName: Text; var TempBlob: Codeunit "Temp Blob")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeSaveAttachmentFromStream(var DocumentAttachment: Record "Human Resource Document"; var RecRef: RecordRef; FileName: Text; var DocStream: InStream)
    begin
    end;
}
