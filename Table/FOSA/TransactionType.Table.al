table 50022 "Transaction -Type"
{
    ...
    fields
    {
        ...
        field(3; Type; Option)
        {
            OptionCaption = 'Teller Cash Deposit,Teller Cheque Deposit,Teller Cash Withdrawal,Teller Ministatement,ATM Card Application,Loan Application,Standing Order,ATM Balance Inquiry-Normal,ATM Withdrawal-Normal,ATM Ministatement-Normal,ATM Paybill-Normal,ATM Buy Goods & Services-Normal,ATM Withdrawal-POS Normal,ATM Deposit-POS Normal,ATM Balance Inquiry-POS Normal,ATM Ministatement-POS Normal,ATM Utility Payment-POS Normal,ATM Balance Inquiry-VISA,ATM Withdrawal-VISA,ATM Ministatement-VISA,ATM Withdrawal-POS VISA,ATM Deposit-POS VISA,ATM Ministatement-POS VISA,ATM Balance Inquiry-POS VISA,ATM Utility Payment-POS VISA,Mobile Banking Balance Inquiry,Mobile Banking Withdrawal,Mobile Banking Ministatement,Mobile Banking Deposit,Cheque Clearance,Cheque Bouncing,E-loan,Agency Withdrawal,Agency Deposit,Agency Airtime,Agency Balance Inquiry,Agency Ministatement,Agency KPLC,Agency KPLC PostPaid,PesaLink,Inter-Account,Tea Payout,Salary Payout,SMS,Teller Cheque Withdrawal,Bank Deposit,Milk And Coffee Payout';
            OptionMembers = "Teller Cash Deposit","Teller Cheque Deposit","Teller Cash Withdrawal","Teller Ministatement","ATM Card Application","Loan Application","Standing Order","ATM Balance Inquiry-Normal","ATM Withdrawal-Normal","ATM Ministatement-Normal","ATM Paybill-Normal","ATM Buy Goods & Services-Normal","ATM Withdrawal-POS Normal","ATM Deposit-POS Normal","ATM Balance Inquiry-POS Normal","ATM Ministatement-POS Normal","ATM Utility Payment-POS Normal","ATM Balance Inquiry-VISA","ATM Withdrawal-VISA","ATM Ministatement-VISA","ATM Withdrawal-POS VISA","ATM Deposit-POS VISA","ATM Ministatement-POS VISA","ATM Balance Inquiry-POS VISA","ATM Utility Payment-POS VISA","Mobile Banking Balance Inquiry","Mobile Banking Withdrawal","Mobile Banking Ministatement","Mobile Banking Deposit","Cheque Clearance","Cheque Bouncing","E-loan","Agency Withdrawal","Agency Deposit","Agency Airtime","Agency Balance Inquiry","Agency Ministatement","Agency KPLC","Agency KPLC PostPaid",PesaLink,"Inter-Account","Tea Payout","Salary Payout",SMS,"Teller Cheque Withdrawal","Bank Deposit","Milk And Coffee Payout";
        }
        ...
        {
            OptionCaption = 'Teller,Mobile Banking,ATM,Agency,Payout,Standing Order';
            OptionMembers = Teller,"Mobile Banking",ATM,Agency,Payout,"Standing Order";
        }
        ...
        field(20; "Calculation Method"; Option)
        {
        ...
        field(22; "Effect on Member Ac"; Option)
        {
            OptionMembers = " ","Debit Amount","Credit Amount";
            OptionCaption = ' ,Debit Amount,Credit Amount';
        }
    }
