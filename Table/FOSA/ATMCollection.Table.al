table 50061 "ATM Collection"
{
    ...
    DrillDownPageID = "ATM Collection List-Approved";
    LookupPageID = "ATM Collection List-Approved";
    ...
    begin
        ATMSetup.GET;
        IF "No." = '' THEN
            "No." := NoSeriesManagement.GetNextNo(ATMSetup."ATM Collection Nos.");
