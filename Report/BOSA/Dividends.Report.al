report 50103 "Dividends Report"
{
    ...
    ApplicationArea = All;
    RDLCLayout = 'Report/BOSA/Dividends Report.rdl';
    ...
    dataset
    {
        dataitem(DataItem1; "Dividend Header")
        {
            ...
            dataitem(DataItem2; "Dividend Line")
            {
                ...
                Column(Member_Deposits_Amount; "Member Deposits Amount")
                {

                }
                Column(Share_Capital_Amount; "Share Capital Amount")
                {

                }
                Column(Interest_On_Deposits_Amount; "Interest On Deposits Amount")
                {

                }
                Column(Dividend_Share_Capital_Amount; "Dividend Share Capital Amount")
                {
