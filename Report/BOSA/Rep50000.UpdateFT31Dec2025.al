report 50990 "Update FT 31 Dec 2025"
{
    ApplicationArea = All;
    Caption = 'Update FT 31 Dec 2025';
    UsageCategory = ReportsAndAnalysis;
    ProcessingOnly = true;
    dataset
    {
        dataitem(FundTransfer; "Fund Transfer")
        {
            ...
            begin
                if FundTransfer.Posted = true then begin
                    if FundTransfer."Posting Date" = 20251231D then begin
                        GLEntry.Reset();
                        GLEntry.SetRange(GLEntry."Document No.", FundTransfer."No.");
                        ...
                        if GLEntry.FindSet() then begin
                            ...
                            FundTransfer.Posted := false;
                            FundTransfer.Status := Status::New;
                            FundTransfer.Modify();
                        end;
                    end;
                end;
            ...
            begin
                ...
                GLEntry.Reset();
                GLEntry.SetRange(GLEntry."Document No.", 'STO');
                GLEntry.SetRange("Posting Date", 20251231D);
                GLEntry.SetRange(Reversed, false);
                if GLEntry.FindSet() then begin
                    repeat
                        ReversalEntry.SetHideWarningDialogs();
