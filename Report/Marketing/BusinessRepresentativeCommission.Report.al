report 50601 "Business Rep Commission Report"
{
    ApplicationArea = All;
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = 'Report/Marketing/Business Rep Commissions.rdl';

    dataset
    {
        dataitem(DataItem1; "Loan Officer Setup")
        {
            DataItemTableView = WHERE(Role = filter('Business Representative'));
