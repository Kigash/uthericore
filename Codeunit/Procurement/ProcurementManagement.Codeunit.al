codeunit 50060 "Procurement Management"
{
    ...
    begin
        WITH GLBudgetName DO BEGIN
            ...
            END ELSE BEGIN
                ...
                ProcurementPlanApprovals2.SETRANGE(Status, ProcurementPlanApprovals2.Status::New);
        ...
        WITH GLBudgetName DO BEGIN
            ...
            IF PlanApprovalSetup.FINDSET THEN BEGIN
                REPEAT
                    ...
                    ProcurementPlanApprovals.Status := ProcurementPlanApprovals.Status::New;
    ...
    begin
        WITH RequisitionHeader DO BEGIN
            ...
            RequisitionHeader2."No." := NoSeriesManagement.GetNextNo(ProcurementSetup."Store Return No.");
            ...
            CASE ProcurementOption OF
                ProcurementOption::Direct:
                    BEGIN
                        ...
                        ProcurementRequest."No." := NoSeriesManagement.GetNextNo(ProcurementSetup."Direct Procurement No.");
                ...
                ProcurementOption::"Low Value":
                    BEGIN
                        ...
                        ProcurementRequest."No." := NoSeriesManagement.GetNextNo(ProcurementSetup."Low Value No.");
                ...
                ProcurementOption::"Request For Quotation":
                    BEGIN
                        ...
                        ProcurementRequest."No." := NoSeriesManagement.GetNextNo(ProcurementSetup."Request For Quotation No.");
                ...
                ProcurementOption::"Request For Proposal":
                    BEGIN
                        ...
                        ProcurementRequest."No." := NoSeriesManagement.GetNextNo(ProcurementSetup."Request For Proposal No.");
                ...
                ProcurementOption::"Open Tender":
                    BEGIN
                        ...
                        ProcurementRequest."No." := NoSeriesManagement.GetNextNo(ProcurementSetup."Open Tender No.");
                ...
                ProcurementOption::"Restricted Tender":
                    BEGIN
                        ...
                        ProcurementRequest."No." := NoSeriesManagement.GetNextNo(ProcurementSetup."Restricted Tender No.");
            ...
            DATABASE::"Procurement Request":
                BEGIN
                    ...
                    WITH ProcurementRequest DO BEGIN
                        ...
                        PurchaseHeader."No." := NoSeriesManagement.GetNextNo(ProcurementSetup."Purchase Order No.");
    ...
    begin
        WITH ProcurementRequest DO BEGIN
            ...
            IF ProcurementProcessEvaluation.FINDFIRST THEN BEGIN
                ContractHeader.INIT;
                ContractHeader."No." := NoSeriesManagement.GetNextNo(ProcurementSetup."Contract No.");
