codeunit 53370 "Bank Acc. Recon Post"
{
    ...
    var
        ...
        Text001: Label 'The reconciliation is incomplete! The net change between statement ending balance and balance last statement does not equal the reconciled amounts';
    ...
    begin
        ...
        with BankAccRecon do begin
            ...
            //Error(TotalTransAmtNotAppliedErr, TotalAppliedAmount + TotalDiff, TotalAmount);
    ...
    begin
        with BankAccReconLine do begin
            ...
            if BankAccRecon."Balance Last Statement" <> 0 then begin
                BankAccRecon.CalcFields("Total Reconciled");
                if BankAccRecon."Total Reconciled" <> BankAccRecon."Difference Btw Statements" then
                    Error(Text001);
            end;
        end;
    ...
    begin
        with BankAcc do begin
            ...
            "Balance Last Statement" := BankAccRecon."Statement Ending Balance";
            Modify;
        end;
    end;
