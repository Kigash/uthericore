codeunit 53372 "Bank Acc Recon Post+Print"
{
    ...
    begin
        ...
        CODEUNIT.Run(CODEUNIT::"Bank Acc. Recon Post", BankAccRecon);
        Rec := BankAccRecon;
        Commit();

        if BankAccStmt.Get(BankAccStmt."Bank Account No.", Rec."Statement No.") then
