    ...
    begin
        WITH TransferFilesLine DO BEGIN
            ...
            IF CONFIRM(TEXT001) THEN BEGIN
                ...
                TransferRegistryFile."Transfer ID" := NoSeriesManagement.GetNextNo(RegistrySetUp."Transfer ID");
    ...
    begin
        WITH TransferFilesLine DO BEGIN
            ...
            IF CONFIRM(TEXT002) THEN BEGIN
                ...
                FileReturn."Return ID" := NoSeriesManagement.GetNextNo(RegistrySetUp."Return ID");
